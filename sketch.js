...
function setup(){
  ...
  H.position(425,10)
  A=createElement("h1")
  A.html(" Ans The Given Question Bellow")
  A.position(300,50)
  B=createElement("h1")
  B.html("Questions ")
  B.position(425,100)
  C=createElement("h2")
  C.html("Q1) Who Is The Indian Cricket Team Captain")
  C.position(50,200)
  D=createElement("h2")
  D.html("a) M.S Dhoni")
  D.position(50,250)
  E=createElement("h2")
  E.html("b) Rohit Sharma")
  E.position(50,300)
  G=createElement("h2")
  G.html("c) Virat Kohli")
  G.position(50,350)
  I=createElement("h2")
  I.html("d) Shikhar Dhawan")
  I.position(50,400)
  bp=createButton("SUBMIT")
  bp.position(100,550)
  bp.mousePressed(logic2)
  output=createInput().attribute("placeholder", "Type The Full Name ")
